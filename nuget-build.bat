...
del Portable_OGCS_v2.12.1.zip
REM https://documentation.help/7-Zip/update1.htm
"c:\Program Files\7-Zip\7z.exe" u Portable_OGCS_v2.12.0.zip -u- -up0q0r2x2y2z1w2!Portable_OGCS_v2.12.1.zip *.dll *.ps1 ErrorReportingTemplate.json logger.xml tzdb.nzd OutlookGoogleCalendarSync.exe OutlookGoogleCalendarSync.exe.config OutlookGoogleCalendarSync.pdb Console\* 
...
"c:\Program Files\7-Zip\7z.exe" a Portable_OGCS_v2.12.1.zip Microsoft.Office.Interop.Outlook.DLL
"c:\Program Files\7-Zip\7z.exe" a Portable_OGCS_v2.12.1.zip stdole.dll
"c:\Program Files\7-Zip\7z.exe" a Portable_OGCS_v2.12.1.zip "Windows Defender SmartScreen Unblock.ps1"
